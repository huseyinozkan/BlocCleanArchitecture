...
final class FileRepository implements IFileRepository {
  ...
  @override
  Future<BaseResponse<FileDto>> save(FileType fileType, Uint8List file) => _fileRemoteDS.save(fileType, file);

  @override
  Future<BaseResponse<FileDto>> update(int id, FileType fileType, Uint8List file) => _fileRemoteDS.update(id, fileType, file);
