...
final class _Body extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isAdmin = context.read<AccountBloc>().isAdmin;
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            verticalBox20,
            if (isAdmin) _MenuRow(onPressed: () => context.pushNamed(RoutePaths.adminOperations.name), title: LocalizationKey.adminOperations.tr(context)),
